...
import { ArrowLeft, Edit, Trash2, Star, BookOpen, Calendar, User } from 'lucide-react'
  ...
  return (
    <div className="flex-1 p-4 md:p-8 pt-6">
      ...
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-800">Detalhes do Livro</h1>
      </div>
            ...
            <CardHeader>
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <CardDescription className="text-xl text-gray-600 flex items-center">
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="text-center">
                    ...
                    <span className="text-sm text-gray-600 ml-1">completo</span>
                  </div>

                  {progressPercentage < 100 && book.currentPage && book.pages && (
